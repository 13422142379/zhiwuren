oS.Init({
	...
	LoadMusic: function() {
		...
		bigImg.src = "images/beijing5.png"; //给img元素的src属性赋值
		//bigImg.width="320";  //320个像素 不用加px
		var myp = document.getElementById('myp4'); //获得dom对象
		myp4.appendChild(bigImg); //为dom添加子元素img
	...
	StartGame: function() {
		...
		NewImg("sod3row", "images/interface/background1.jpg", "left:-118px;clip:rect(0,264px,600px,0);z-index:0", EDAll);
