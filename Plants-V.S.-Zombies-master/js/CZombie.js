var CZombies = function(b, a) {
	...
	oConeheadZombie = InheritO(OrnIZombies, {
		...
		PicArr: (function() {
			...
			return [b + "ConeheadZombie.gif", b + "ConeheadZombieAttack.gif", b + "ConeheadZombieLostHead.gif", b + "ConeheadZombieLostHeadAttack.gif", b + "ConeheadZombieHead.gif" + $Random, b + "ConeheadZombieDie.gif" + $Random, b + "3.gif" + $Random, b + "2.gif", b + "2.gif"]
		})(),
