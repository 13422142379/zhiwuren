var $User = function() {//游戏检测硬件运行环境
	...
	oP = {
		...
		SetTimeoutZombie: function(b, d) {//僵尸消失
			var f = [],
				c = [],
				e = delayT = 0,
				a = b.length;
